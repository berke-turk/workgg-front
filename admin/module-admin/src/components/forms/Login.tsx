...
export default function Login() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg sm:w-80 mx-auto">
      <div className="mb-5">
        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">E-posta</label>
        <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="admin@workgg.com" required />
      </div>
      <div className="mb-5">
      ...
      {fetchLoadingState.isActive == false && (
        <button type="submit" className="text-white bg-[#00bfa5] hover:bg-[#00bfa5] focus:ring-4 focus:outline-none focus:bg-[#00bfa5] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-[#00bfa5] dark:hover:bg-[#00bfa5] dark:focus:ring-[#00bfa5]">Giriş</button>
      )}
