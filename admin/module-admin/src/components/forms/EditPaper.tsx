...
export default function Form(content: EditPaperFormI) {
        ...
        <div className="h-auto p-0 w-full flex flex-col justify-start items-center sm:flex-row sm:flex sm:items-start">
            <form onSubmit={handleSubmit} className="w-full flex flex-col sm:flex-wrap sm:max-w-[600px]">
                ...
                <div className="mb-5 sm:mr-5">
                    ...
                    <input disabled={fetchLoadingState.isActive} type="text" id="title" value={content.data?.title} onChange={() => { }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Açıklama</label>
                    <textarea disabled={fetchLoadingState.isActive} id="description" value={content.data?.description} onChange={() => { }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="keywords" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Anahtar Sözcükler</label>
                    <textarea disabled={fetchLoadingState.isActive} id="keywords" value={content.data?.keywords} onChange={() => { }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="volume-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cilt</label>
                    <input disabled={fetchLoadingState.isActive} type="number" value={content.data?.volume} onChange={() => { }} id="volume-input" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90210" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="subvolume-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sayı</label>
                    <input disabled={fetchLoadingState.isActive} type="number" value={content.data?.sub_volume} onChange={() => { }} id="subvolume-input" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90210" required />
                </div>
                <div className="w-full flex-col items-start mb-5">
                    ...
                    <select disabled={fetchLoadingState.isActive} id="countries" defaultValue={content.data?.status} onChange={() => { }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
