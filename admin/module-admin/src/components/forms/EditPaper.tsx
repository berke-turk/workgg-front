...
export default async function Form(content: EditPaperFormI) {
        ...
        <div className="h-auto p-0 w-full flex flex-col justify-start items-center sm:flex-row sm:flex sm:items-start">
            <form className="w-full flex flex-col sm:flex-wrap sm:max-w-[600px]">
                ...
                <div className="mb-5 sm:mr-5">
                    ...
                    <input type="text" id="title" value={data?.title} onChange={()=>{}} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Açıklama</label>
                    <textarea id="description" value={data?.description} onChange={()=>{}} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="keywords" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Anahtar Sözcükler</label>
                    <textarea id="keywords" value={data?.keywords} onChange={()=>{}} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="volume-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cilt</label>
                    <input type="number" value={data?.volume} onChange={()=>{}} id="volume-input" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90210" required />
                </div>
                <div className="mb-5 sm:mr-5">
                    <label htmlFor="subvolume-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sayı</label>
                    <input type="number" value={data?.sub_volume} onChange={()=>{}} id="subvolume-input" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90210" required />
                </div>
                <div className="w-full flex-col items-start mb-5">
                    ...
                    <select id="countries" defaultValue={data?.status} onChange={()=>{}} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div className='mt-5'>
                    <span>
                        Dosyayı değiştirmek istiyorsanız, mevcut dosyayı silip yeniden yükleyebilirsiniz.
                    </span>
                </div>
                <div className='mt-5 flex items-center justify-start'>
                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kaydet</button>
                    <div className='ml-5'>
...
export function FetchData(id?: string | null): PaperDataI | null {
    if (id == null)
        return null;
...
export function UpdateData(id?: string | null): PaperDataI | null {
    if (id == null)
        return null;
    ...
    //
    let re: PaperDataI = { id: id, status: 'passive', title: "ABECE" };
