...
class DatabaseConnection {
    ...
    async queryWithNamedParams<T = any>(
        ...
        // Özel Karakter Güvenliği:
        // pg kütüphanesi, tüm parametre değerlerini güvenli bir şekilde işler.
        // Bu, tırnak işaretleri (', ") veya diğer özel karakterler (-, \, vb.) 
        // içeren değerlerin otomatik olarak doğru şekilde escape edilmesini sağlar.
        try {
